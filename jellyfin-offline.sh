...
curl -L https://www.nuget.org/api/v2/package/Microsoft.NETCore.App.Host.linux-x64/${DOTNET_VERSION} >  microsoft.netcore.app.host.linux-x64.${DOTNET_VERSION}.nupkg
